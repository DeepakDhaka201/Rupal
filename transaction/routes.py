        ...
        for transaction in transaction_records:
            ...
            if claim:
                active_transactions.append({
                    ...
                    'payment_mode': TransactionType[transaction.payment_mode].value,
        ...
        for transaction in active_transactions:
            ...
            if claim:
                active_claims.append({
                    ...
                    'amount_inr': transaction.amount_inr,
                    'amount_usdt': transaction.amount_usdt,
                    'payment_mode': TransactionType[transaction.payment_mode].value if transaction.payment_mode else None,
                    'rate': transaction.rate,
                    'payment_reference': transaction.payment_reference,
                    'created_at': transaction.created_at.isoformat(),
                    'claim': {
